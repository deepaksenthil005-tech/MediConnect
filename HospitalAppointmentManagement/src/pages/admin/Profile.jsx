          ...
          <div className="bg-white p-5 md:p-6 lg:p-8 rounded-[1rem] border border-slate-100 shadow-xl shadow-slate-200/50">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  {["Male", "Female", "Other"].map((g) => (
                    <button
                      ...
                      className={`py-3 md:py-4 rounded-xl md:rounded-2xl border transition-all font-black text-xs uppercase tracking-widest ${
                        form.gender === g
              ...
              <div className="flex justify-end">
                <button
                  type="submit"
                  className={`px-8 py-3 md:px-10 md:py-4 rounded-xl md:rounded-2xl transition-all font-black uppercase tracking-widest text-sm ${
                    saved
